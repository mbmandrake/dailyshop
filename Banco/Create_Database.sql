...
CREATE TABLE USUARIO (
	...
	BL_ATIVO BIT NOT NULL,
	DT_REGISTRO DATETIME NOT NULL,
	CONSTRAINT FK_ENDERECO_REF_USUARIO FOREIGN KEY (ID_ENDERECO) REFERENCES ENDERECO (ID_ENDERECO),
	CONSTRAINT FK_GRUPO_REF_USUARIO FOREIGN KEY (ID_GRUPO) REFERENCES GRUPO (ID_GRUPO)
);
GO
...
CREATE TABLE LISTA_PRODUTO (
	...
	BL_ATIVO BIT NOT NULL,
	DT_REGISTRO DATETIME NOT NULL,
	CONSTRAINT FK_USUARIO_REF_LPROD FOREIGN KEY (ID_USUARIO) REFERENCES USUARIO (ID_USUARIO)
);
GO
